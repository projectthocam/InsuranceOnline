...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        [Obsolete]
        public CategoryController(Microsoft.AspNetCore.Hosting.IHostingEnvironment environment, IConfiguration Aconfiguration, INotyfService notifyService)
        {
        ...
        public async Task<IActionResult> Create(Category category, IFormFile? ImageFile)
        {
            if (ModelState.IsValid)
            {
                ...
                db.Add(category);
                _notifyService.Success("Add Category Success!!!");
        ...
        public async Task<IActionResult> Edit(int id, Category category, IFormFile? ImageFile)
        {
            ...
            try
            {
                ...
                db.Update(category);
                _notifyService.Success("Update Category Success!!!");
                await db.SaveChangesAsync();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            _notifyService.Success("Delete Category Success!!!");
            await db.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
