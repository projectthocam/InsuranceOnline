...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class InsuranceController : Controller
    {
        ...
        [Obsolete]
        public InsuranceController(Microsoft.AspNetCore.Hosting.IHostingEnvironment environment, IConfiguration Aconfiguration, INotyfService notifyService)
        {
        ...
        public async Task<IActionResult> Create(Insurance insurance, IFormFile? ImageFile)
        {
            if (ModelState.IsValid)
            {
                ...
                db.Add(insurance);
                _notifyService.Success("Add Insurance Success!!!");
        ...
        public async Task<IActionResult> Edit(int id, Insurance insurance, IFormFile? ImageFile)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    db.Update(insurance);
                    _notifyService.Success("Update Insurance Success!!!");
                    await db.SaveChangesAsync();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            _notifyService.Success("Delete Insurance Success!!!");
            await db.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
