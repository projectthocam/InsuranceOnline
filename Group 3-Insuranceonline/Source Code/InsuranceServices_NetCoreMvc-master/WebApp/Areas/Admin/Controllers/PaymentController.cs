...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class PaymentController : Controller
    {
        ...
        public PaymentController(INotyfService notifyService)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Total,ContractId")] Payment payment)
        {
            ...
            {
                db.Add(payment);
                _notifyService.Success("Add Payment Success!!!");
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Total,ContractId")] Payment payment)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    db.Update(payment);
                    _notifyService.Success("Update Payment Success!!!");
                    await db.SaveChangesAsync();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            _notifyService.Success("Delete Payment Success!!!");
            await db.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
