...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class ReplyController : Controller
    {
        ...
        public ReplyController(INotyfService notifyService)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Answer,CreatedAt,UpdatedAt,FaqsId")] Reply reply)
        {
            ...
            {
                db.Add(reply);
                _notifyService.Success("Add Reply Success!!!");
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Answer,CreatedAt,UpdatedAt,FaqsId")] Reply reply)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    db.Update(reply);
                    _notifyService.Success("Update Reply Success!!!");
                    await db.SaveChangesAsync();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            _notifyService.Success("Delete Reply Success!!!");
            await db.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
