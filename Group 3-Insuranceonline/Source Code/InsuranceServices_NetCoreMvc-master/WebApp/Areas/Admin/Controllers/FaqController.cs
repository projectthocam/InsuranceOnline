...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class FaqController : Controller
    {
        ...
        public FaqController(INotyfService notifyService)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Question,CreatedAt,UpdatedAt")] Faq faq)
        {
            ...
            {
                db.Add(faq);
                _notifyService.Success("Add Faq Success!!!");
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Question,CreatedAt,UpdatedAt")] Faq faq)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    db.Update(faq);
                    _notifyService.Success("Update Faq Success!!!");
                    await db.SaveChangesAsync();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            _notifyService.Success("Delete Faq Success!!!");
            await db.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
